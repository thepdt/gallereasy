...
const Collapses = React.lazy(() => import('./components/Collapses'));
const Dropdowns = React.lazy(() => import('./components/Dropdowns'));
const Forms = React.lazy(() => import('./components/Forms'));
const Jumbotrons = React.lazy(() => import('./components/Jumbotrons'));
const ListGroups = React.lazy(() => import('./components/ListGroups'));
const Navbars = React.lazy(() => import('./components/Navbars'));
const Navs = React.lazy(() => import('./components/Navs'));
const Paginations = React.lazy(() => import('./components/Paginations'));
const Popovers = React.lazy(() => import('./components/Popovers'));
const ProgressBar = React.lazy(() => import('./components/ProgressBar'));
const Switches = React.lazy(() => import('./components/Switches'));
const Tables = React.lazy(() => import('./components/Tables'));
const Tabs = React.lazy(() => import('./components/Tabs'));
const Tooltips = React.lazy(() => import('./components/Tooltips'));
...
const Posts = React.lazy(() => import('./views/Manage/Posts'));
...
const routes = [
    ...
    { path: '/manage', exact: true,  name: 'Manage', component: Posts },
    { path: '/manage/posts', exact: true,  name: 'Posts', component: Posts },
